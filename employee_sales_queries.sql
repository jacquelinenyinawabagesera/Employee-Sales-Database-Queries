...
SELECT e.first_name,e.last_name, es.total
FROM employee_sales.employees e
JOIN employee_sales.sales es
...
SELECT 
    ...
    AVG(sales.quantity) AS average_quantity
FROM employee_sales.employees
JOIN employee_sales.sales
ON employees.employee_id = sales.employee_id
...
SELECT 
    ...
    employees.first_name,
    employees.last_name,
    SUM(sales.total) AS total_sales_2021
FROM employee_sales.employees
JOIN employee_sales.sales
ON employees.employee_id = sales.employee_id
...
FROM employee_sales.sales
JOIN employee_sales.products
